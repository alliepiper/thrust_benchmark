                                     ...
                                     nvbench::enum_type<Pattern>>)
{
  ...
  T step = (upper_level - lower_level) / BinsCount;
  thrust::device_vector<int> levels(num_bins + 1);
  ...
  state.exec([&](nvbench::launch &launch) {
    ...
    cub::DeviceHistogram::HistogramRange(thrust::raw_pointer_cast(tmp.data()),
                                         temp_size,
                                         input.cbegin(),
                                         thrust::raw_pointer_cast(histogram.data()),
                                         num_levels,
...
NVBENCH_BENCH_TYPES(basic,
  ...
  .set_name("cub::DeviceHistogram::HistogramRange")
